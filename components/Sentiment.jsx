    ...
    <div className="max-w-[881px] rounded-[8px] bg-[#FFFFFF] flex flex-col p-[24px] ">
      ...
      <div className="flex flex-col gap-[17px]">
        ...
        <div className="h-[204px]">
          ...
          >
            <div className="w-[456px] min-w-[456px] h-[204px] rounded-[12px] px-[18px] pt-[18px] pb-[38px] bg-[#E8F4FD]">
              <div className="flex flex-row gap-2">
                <Image
                  ...
                  height={44}
                  alt="arrow"
                  className="relative bottom-[55px]"
                />
                <div className="flex flex-col gap-2">
                  <div className="font-[500] text-[14px] leading-[20px] flex items-center">
                    Lorem ipsum dolor sit amet consectetur. Dui vel quis
                    dignissim mattis enim tincidunt.
                  </div>
                  <div className="font-[400] text-[14px] leading-[20px] flex items-center text-[#3E5765]">
            ...
            <div className=" w-[456px] min-w-[456px] h-[204px] rounded-[12px] px-[18px] pt-[18px] pb-[38px] bg-[#EBF9F4]">
              <div className="flex flex-row gap-2">
                <Image
                  src="/Sent2.svg"
                  width={44}
          ...
          <button
            ...
            className="w-[60px] h-[60px] bg-[#FFFFFF] rounded-[50%] flex justify-center items-center relative bottom-[130px] left-[760px]"
          >
          ...
          <div className="flex flex-row gap-[40px]">
            ...
            <div className="flex flex-col">
                <div className="flex flex-row items-center h-[38px] gap-[10px]">
                    ...
                    <div className="w-[349.14px] h-[8px] rounded-[2px] bg-[#00B386] ml-[15px]"></div>
